...
namespace IntegrationHub.SRP.Services
{
    ...
    public class PeselService
    {
        ...
        public PeselService(IOptions<PeselServiceSettings> peselSoapSettings, IPeselSoapMapper mapper, IPeselSoapClient peselSoapClient, ILogger<PeselService> logger)
        {
